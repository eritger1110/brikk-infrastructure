...
class BillingPortalRequestSchema(Schema):
    ...
    customer_id = fields.Str(required=True, validate=lambda x: x.startswith('cus_'))
...
def create_billing_portal():
    ...
    try:
        ...
        return_url = data.get('return_url', request.host_url.rstrip('/') + '/billing/complete')
        ...
        try:
            ...
            logger.warning(f"Invalid Stripe request for customer {customer_id}: {str(e)}")
