    ...
    def test_coordination_endpoint_exists(self, base_url):
        ...
        try:
            ...
            response = requests.post(
                f"{base_url}/api/v1/coordination", timeout=5)
    ...
    def test_redis_container_health(self):
        ...
        try:
            ...
            if result.returncode == 0 and result.stdout.strip():
                ...
                pytest.skip(
                    "Redis container not running - start with 'make up'")
...
class TestEnvironmentConfiguration:
    ...
    def test_development_environment_variables(self):
        ...
        if missing_vars:
            pytest.skip(
                f"Development environment not configured. Missing: {missing_vars}")
    ...
    def test_feature_flags_configuration(self):
        ...
        for flag, expected in feature_flags.items():
            ...
            if actual and actual != expected:
                print(
                    f"Warning: {flag}={actual}, expected {expected} for local dev")
