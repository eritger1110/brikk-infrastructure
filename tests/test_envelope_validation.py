...
def allow_uuid4_for_tests(monkeypatch):
    monkeypatch.setenv("BRIKK_ALLOW_UUID4", "true")
...
class TestCreateSampleEnvelope:
    ...
    def test_create_sample_envelope_defaults(self):
        "Test that sample envelope is created with default values."
    ...
    def test_create_sample_envelope_custom_params(self):
        "Test that sample envelope is created with custom parameters."
        payload = {
