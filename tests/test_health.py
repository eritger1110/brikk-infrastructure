...
class TestReadinessEndpoint:
    ...
    def test_readiness_endpoint_all_dependencies_healthy(
            self, mock_redis, client):
...
class TestHealthEndpointPerformance:
    ...
    @patch('src.services.rate_limit.redis')
    def test_readiness_endpoint_reasonable_response_time(
            self, mock_redis, client):
...
class TestHealthEndpointErrorHandling:
    ...
    @patch('src.services.rate_limit.redis')
    def test_readiness_handles_unexpected_redis_errors(
            self, mock_redis, client):
